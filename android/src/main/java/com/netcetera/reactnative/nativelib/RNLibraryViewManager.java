package com.netcetera.reactnative.nativelib;
...
public class RNLibraryViewManager extends SimpleViewManager<com.inprogress.reactnativeyoutube.YouTubeView> {

    public static final String REACT_CLASS = "RNLibraryViewManager";
